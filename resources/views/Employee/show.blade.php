                                    ...
                                    <td class ='text-center'>
                                       ...
                                       <a href="/admin/employee/edit/2">
                                        ...
                                        <a href="/admin/employee/fire/2">
                                            <button class="btn-second mr-2  " style='border:none; padding: 6px 23px;border-radius: 6px;'>
                                                Fire
                                            </button>
                                        </a>
                                        

                                        <a href="/admin/employee/delete/2">
                                            <button class="btn-danger" style='border:none; padding: 6px 23px;border-radius: 6px;'>
                                                Delete
                                            </button>
                                        </a>
